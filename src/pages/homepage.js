...
const HomePage = () => (
  <Layout>
    ...
    <div
      style={{backgroundColor:'var(--light)', display:'flex', justifyContent:'center', padding:'1rem'}}
    >
      <h2>Comunicados</h2>
    </div>
    <div
      style={{backgroundColor:'var(--dark-grey)', display:'flex', flexDirection: 'column', justifyContent:'center', padding:'1rem', color:'white'}}
    >
      <h2>Sobre nós</h2>
